...
# Plot 4: Four Graphs on One Screen
  # Set to png and WxH parameters
    png(filename = "plot4.png", width = 480, height = 480)
  # Use par() with mfrow() to set plots 2x2 print out
    par(mfrow = c(2, 2))
    
  # Upper Left Plot
    with(feb_days, plot(DateTime, Global_active_power, 
                        type = "l", ylab = "Global Active Power (kilowatts)", xlab = ""))
  # Upper Right Plot
    with(feb_days, plot(DateTime, Voltage, type = "l"))
  ...
  # Lower Right Plot
    with(feb_days, plot(DateTime, Global_reactive_power, type = "l"))
